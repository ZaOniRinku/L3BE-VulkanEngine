...
void GraphicsEngine::updateUniformBuffer(SGNode* node, uint32_t currentImage) {
...
void GraphicsEngine::createTextureImage(SGNode* node) {
	Object* obj = node->getObject();
...
void GraphicsEngine::createTextureImageView(SGNode* node) {
	Object* obj = node->getObject();
...
void GraphicsEngine::createTextureSampler(SGNode* node) {
	Object* obj = node->getObject();
...
void GraphicsEngine::loadModel(SGNode* node) {
	Object* obj = node->getObject();
...
void GraphicsEngine::createVertexBuffer(SGNode* node) {
	Object* obj = node->getObject();
...
void GraphicsEngine::createIndexBuffer(SGNode* node) {
	Object* obj = node->getObject();
...
void GraphicsEngine::updateDescriptorSets(SGNode* node, int frame, int nbDesc) {
	Object* obj = node->getObject();
